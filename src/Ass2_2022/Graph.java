...
public abstract class Graph {
     ...
     *  is specified, weight defaults to 1.
     */
     ...
     *  (y,x) is an edge.  For an undirected graph, these two quantities are equal and are referred to as just the "degree"
     ...
     *  vertices) and whether (x, y, weight) is a valid weighted edge (i.e., whether x and y are both valid vertices
